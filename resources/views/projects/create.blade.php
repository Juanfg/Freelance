...
<div class="row">
    <div class="col-xs-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-md-12"  data-step="1" data-intro="This is the form to create a new project" data-position="top">
                    <form enctype="multipart/form-data" id="upload_form" role="form" method="POST" action="" name="form-data">
                        ...
                        <div class="form-group col-md-6" data-step="2" data-intro="If you want to add multiple photos related to your project, click this button" data-position="left">
                        ...
                        <div class="form-group col-md-6" data-step="3" data-intro="Please tell us how difficult is your project" data-position="top">
                        ...
                        <div class="form-group col-md-6" data-step="4" data-intro="If you want to add a pdf related to your project, click here and add it" data-position="left">
                ...
                <div class="form-group col-md-12" style="margin-top: 5px;" data-step="5" data-intro="If you think that there is a category from here related to your project, drag it to the green box" data-position="top">
                    <div class="col-md-12">
